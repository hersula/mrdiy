window.LobiAdminConfig = {
    ...
    error404Page                    : base_url + 'error/Err/error_404/',
...
/*window.LobiAdminRoutes = {
    'dashboard' : base_url + 'index.php/Dashboard'
...
// window.LobiAdminRoutes = menu_lists;
window.LobiAdminRoutes = {
    '(.+)' : base_url + '$1',
};
