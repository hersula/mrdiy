  ...
  class Datatables
  {
    ...
    */
    public function where_in($key_condition, $val = NULL)
    {
	 ...
	 /**
    * Generates the OR WHERE IN portion of the query
    *
    * @param mixed $key_condition
    * @param string $val
    * @param bool $backtick_protect
    ...
    */
    public function or_where_in($key_condition, $val = NULL)
    {
      ...
      $this->ci->db->or_where_in($key_condition, $val);
      return $this;
    }
	 /**
    ...
    */
    public function where_not_in($key_condition, $val = NULL)
    {
	 ...
	 /**
    * Generates the OR WHERE NOT IN portion of the query
    *
    * @param mixed $key_condition
    * @param string $val
    * @param bool $backtick_protect
    * @return mixed
    */
    public function or_where_not_in($key_condition, $val = NULL)
    {
      $this->or_where_not_in[] = array($key_condition, $val);
      $this->ci->db->or_where_not_in($key_condition, $val);
      return $this;
    }
    /**
    * Generates the WHERE portion of the query
    ...
    */
    private function get_total_results($filtering = FALSE)
    {
      ...
      foreach($this->where_in as $val)
        ...
        $this->ci->db->or_where_in($val[0], $val[1]);
		foreach($this->where_not_in as $val)
        $this->ci->db->where_not_in($val[0], $val[1]);
		foreach($this->or_where_not_in as $val)
        $this->ci->db->or_where_not_in($val[0], $val[1]);
