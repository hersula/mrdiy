    ...
    <script type="text/javascript">
        (function() {
            ...
            LobiAdmin.loadScript([
                '<?= base_url() ?>assets/js/plugin/sparkline/jquery.sparkline.min.js'
            ], initSparklines);

            //Load and initialize chartjs
            LobiAdmin.loadScript([
                '<?= base_url() ?>assets/js/plugin/chartjs/Chart.min.js'
            ], initChartjs);

            //Load and initialize lobilist
            LobiAdmin.loadScript([
                '<?= base_url() ?>assets/js/lobi-plugins/lobilist.min.js'
            ], initLobiList);

            LobiAdmin.loadScript([
                '<?= base_url() ?>assets/js/plugin/moment/moment.min.js'
            ], function() {
                LobiAdmin.loadScript('<?= base_url() ?>assets/js/plugin/fullcalendar/fullcalendar.min.js', initPage);
            });
