      ...
      <div class="card">
         <div class="card-body">
            <div class="alert alert-primary mb-0" role="alert">
               <h4 class="alert-heading font-18">Akses User B2B</h4>
            </div>
         </div>
      </div>
   </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                           <input type="hidden" name="supp_id" id="supp_id" value="" readonly="readonly" />
                           <input type="text" class="form-control font-size-sm" placeholder="Supplier Name" name="supp_name" id="supp_name" value="" readonly="readonly" />
                           <div class="input-group-append">
                              <button class="btn btn-outline-info btn-sm waves-effect waves-light" type="button"
                              onclick="LOVSupp();"><i class="fas fa-search"></i></button>
                              <button class="btn btn-outline-warning btn-sm waves-effect waves-light" type="button"
                              onclick="LOVSuppClear();"><i class="mdi mdi-close"></i></button>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 mt-3">
                     <div class="form-group">
                        ...
                        <input type="checkbox" class="form-control" id="status" name="status" switch="success" value="1"
                           checked />
