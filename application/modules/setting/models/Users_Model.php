...
class Users_Model extends Core_Model {
   ...
   *******************************************************************************/
	...
	function getData2Edit($id) {
		$Qry = $this->db->query("SELECT a.user_id, a.name, a.role_id, b.role_name, CASE WHEN a.active='true' THEN 1 ELSE 0 END AS active
										FROM app_users a 
	...
	function getList($filter) {
		$this->datatables->select("a.id, a.user_id, a.name, a.role_id, CASE WHEN a.active='true' THEN 1 ELSE 0 END AS active");
	...
	function getDataList($filter) {
		$this->db->select("a.user_id, a.name, a.role_id, b.role_name, CASE WHEN a.active='true' THEN 'Aktif' ELSE 'Tidak Aktif' END AS active");
