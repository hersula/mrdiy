      ...
      <div class="card">
         <div class="card-body">
            <div class="alert alert-info mb-0" role="alert">
               <h4 class="alert-heading font-18">Master Site</h4>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control font-size-sm" placeholder="Site Code" id="kd_site" name="kd_site" value="" maxlength="6" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Site Name *</label>
                        <input type="text" class="form-control font-size-sm" placeholder="Site Name" id="nm_site" name="nm_site" value="" maxlength="50" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
