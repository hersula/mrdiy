      ...
      <div class="card">
         <div class="card-body">
            <div class="alert alert-info mb-0" role="alert">
               <h4 class="alert-heading font-18">Master Type</h4>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control font-size-sm" placeholder="Type Code" id="kd_type" name="kd_type" value="" maxlength="6" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Type Name *</label>
                        <input type="text" class="form-control font-size-sm" placeholder="Type Name" id="nm_type" name="nm_type" value="" maxlength="50" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
