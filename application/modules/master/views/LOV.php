<!-- Modal -->
<div class="modal fade" id="ModalLOV" role="dialog">
	...
	function iniDataTable() {
		...
		DT_columnDefs.push({
			...
			"render": function ( data, type, full, meta ) {
				return '<button class="btn btn-xs btn-white btn-success" title="Ambil Value" onclick="SendValues(' + meta.row + ')"><i class="fa fa-check"></i> </button>';
			},
		});
