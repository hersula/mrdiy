      ...
      <div class="card">
         <div class="card-body">
            <div class="alert alert-info mb-0" role="alert">
               <h4 class="alert-heading font-18">Master Store</h4>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control font-size-sm" placeholder="Store Code" id="kd_store" name="kd_store" value="" maxlength="6" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Store Name *</label>
                        <input type="text" class="form-control font-size-sm" placeholder="Store Name" id="nm_store" name="nm_store" value="" maxlength="50" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
