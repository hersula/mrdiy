      ...
      <div class="card">
         <div class="card-body">
            <div class="alert alert-info mb-0" role="alert">
               <h4 class="alert-heading font-18">Master Priority</h4>
            </div>
         </div>
      </div>
   </div>
...
<div class="row">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control font-size-sm" placeholder="Priority Code" id="kd_priority" name="kd_priority" value="" maxlength="6" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Priority Name *</label>
                        <input type="text" class="form-control font-size-sm" placeholder="Priority Name" id="nm_priority" name="nm_priority" value="" maxlength="50" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
   ...
   <div class="col-md-8 pull-right">
      ...
      <div class="col-md-12">
         <div class="card">
            <div class="card-body">
               <table id="table_list_data" class="table table-striped table-bordered dt-responsive nowrap text-nowrap" cellspacing="0" width="100%">
                  <thead>
                     <tr>
                        <th>Priority Code</th>
                        <th>Priority Name</th>
