      ...
      <div class="card">
         <div class="card-body">
            <div class="alert alert-info mb-0" role="alert">
               <h4 class="alert-heading font-18">Master Category</h4>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control font-size-sm" placeholder="Category Code" id="kd_category" name="kd_category" value="" maxlength="6" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
                        <label>Category Name *</label>
                        <input type="text" class="form-control font-size-sm" placeholder="Category Name" id="nm_category" name="nm_category" value="" maxlength="50" />
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
